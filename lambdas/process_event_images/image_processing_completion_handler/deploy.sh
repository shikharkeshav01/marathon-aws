...
# Deploy script for image_processing_completion_handler
# Can be run standalone or called from main deploy.sh with parameters

LAMBDA_NAME="image_processing_completion_handler"
LAMBDA_TIMEOUT=120
...
ZIP_FILE="${SCRIPT_DIR}/../image_processing_completion_handler.zip"
